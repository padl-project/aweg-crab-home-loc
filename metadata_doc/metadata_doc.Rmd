---
title: "Crab Home Range Location"
author: "Alex Wegmann"
date: "10/15/2021"
...
2005 Palmyra Atoll Crabs Home Range Locations
...
<!--_Include what, where, and when in the dataset title_-->
 ...
 - 2005_palmyra_atoll_crab_home_range_locations.csv
...
p_organization <- c("The Nature Conservancy", "PADL Data Manager, University of California Santa Barbara")
p_email <- c("alex.wegmann@tnc.org", "camilavargas@ucsb.edu")
p_orcid <- c("", "")
...
Description <- c("2005-01-18", "2005-11-05", "Completed")
...
path_data <- here::here("clean_data")
path_templates <- here::here("data_attributes")
file1_name <- "2005_palmyra_atoll_crab_home_range_locations"
...
data_attributes1 <- read.delim2(here::here(paste0("data_attributes/attributes_", file1_name, ".txt"))) %>% 
  mutate(unit = case_when(unit == "!Add units here!" ~ "*"))

# data_attributes2 <- read.delim2(here::here(paste0("data_attributes/attributes_", file2_name, ".txt"))) %>% 
#   mutate(unit = case_when(unit == "!Add units here!" ~ "*"))
...
cat_vars <- read.delim2(here::here(paste0("data_attributes/catvars_", file1_name, ".txt")))
